...
class BlueyeControllerGUI:
    def __init__(self, master):
        ...
        self.label_ascend_value = ctk.CTkLabel(mode_button_container, text="0.5")
        ...
        self.label_descend_value = ctk.CTkLabel(mode_button_container, text="0.5")
        ...
        self.mode_vals = [0.0, 0.5, 0.5, 0.0]
