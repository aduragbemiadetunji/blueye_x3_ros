...
def stateEstimator(msg, tune_vals):
    ...
    process_noise_covariance = np.diag([tune_vals[0], tune_vals[1], tune_vals[2]]) #psidot, rdot, bspidot
    measurement_noise_covariance = np.diag([tune_vals[3], tune_vals[4]]) #psi, r
